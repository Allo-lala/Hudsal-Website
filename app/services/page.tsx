...
const products = [
  {
    ...
    highlights: [
      "Access Business Health Check",
      "Access Workforce & Rota Stress Index",
      "Access Inspection Pressure Brief",
      "Access Leadership Pressure Map",
  ...
  },
  {
    ...
    highlights: [
      "Access Business Stability Scorecard",
