...
import { Sparkles, Target, Eye, Heart, Users, Award, Clock } from "lucide-react";

export const metadata = {
  title: "About Us - Hudsal Healthcare",
  description: "Learn about Hudsal Healthcare - our mission, vision, and commitment to providing exceptional care services across the UK.",
};
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="bg-card border border-border rounded-2xl p-8">
              <div className="w-14 h-14 rounded-lg bg-emerald/10 flex items-center justify-center mb-6">
                <Target className="w-7 h-7 text-emerald" />
              </div>
