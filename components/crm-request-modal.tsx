            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                ...
                <Textarea
                  ...
                  onChange={handleInputChange}
                  placeholder="e.g., CRM, Manual Paperwork, Drop Box, Excel, Roundsy etc."
                  rows={3}
                  className="mt-1"
                />
              </div>
        ...
        {step === "success" && (
          <div className="p-8 text-center">
            ...
            <p className="text-muted-foreground mb-6">
              Thank you for your interest in our CRM platform. We'll review your request and contact you shortly for a free CRM configuration.
            </p>
            <Button 
              onClick={handleClose}
