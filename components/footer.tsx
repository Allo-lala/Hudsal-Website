          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
            ...
            <div className="lg:col-span-1">
              ...
              <ul className="flex gap-4">
                <li>
                  <a href="https://www.youtube.com/channel/UCuAdnK27hNerOP0jZkWAARQ" target="_blank" className="text-gray-400 hover:text-white" aria-label="Youtube">
                ...
                <li>
                  <a href="mailto:admin@hadsul.co.uk" className="text-gray-400 hover:text-white" aria-label="Email">
            ...
            <div className="absolute bottom-16 right-0 bg-white rounded-2xl shadow-2xl border border-emerald/20 p-4 min-w-[200px] animate-in fade-in slide-in-from-bottom-2">
              <div className="space-y-3">
                ...
                >
                  ...
                  <div>
                    <p className="text-sm font-semibold text-foreground group-hover:text-emerald">LinkedIn</p>
                  </div>
                </a>
                ...
                >
                  ...
                  <div>
                    <p className="text-sm font-semibold text-foreground group-hover:text-emerald">Instagram</p>
                  </div>
                </a>
                ...
                >
                  ...
                  <div>
                    <p className="text-sm font-semibold text-foreground group-hover:text-emerald">X (Twitter)</p>
                  </div>
                </a>
                ...
                >
                  ...
                  <div>
                    <p className="text-sm font-semibold text-foreground group-hover:text-emerald">Facebook</p>
                  </div>
                </a>
