...
export function Hero() {
  ...
  return (
    <section className="relative min-h-screen bg-[#1a2e1a] overflow-hidden">
      ...
      {/* Content */}
      <div className="relative z-10 max-w-7xl mx-auto pl-8 md:pl-12 lg:pl-16 pr-4 sm:pr-6 lg:pr-8 pt-32 pb-20 min-h-screen flex items-center">
            ...
            >
              ...
              <text className="fill-white text-xs uppercase tracking-widest">
                <textPath href="#circlePath">
                  • HEALTHCARE STAFFING • CONSULTANCY • IT SOLUTIONS •
                </textPath>
              </text>
            </svg>
